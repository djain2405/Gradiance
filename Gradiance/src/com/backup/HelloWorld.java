...
public class HelloWorld {
	...
	//		for(int s: array)
	  ...
	  static void func(String exerID1, String userID1, String couID1){
		//  String exerID="HW1";
		//  String userID="jmick";
		//  String couID="CSC540";
...
////
	          ...
	          {
	        	  String sval;
	        	  sql="SELECT * FROM QUESTIONS_PARAM WHERE QUESTION_ID="+qid[index-1];
	        	  ...
	        	  i=0;
			         ...
			         while(  i < par.length){  
			        	 if(i==0)
			        	 paramq=question[index-1].replaceFirst("\\<[^>]*\\>", par[i]);
			        	 else
			        	 paramq=paramq.replaceFirst("\\<[^>]*\\>", par[i]); 
	        	  // question[index-1] = rs.getString("TEXT");
	       // 	System.out.println( question[index-1].replaceFirst("\\<[^>]*\\>", par[i]));
			         i++;
			         }
	        	  }
	         ...
	         if(index1==0)
	        	 sql = "SELECT * FROM ANSWERS WHERE QUESTION_ID="+qid[index-1]+"AND IS_CORRECT='Y' AND ROWNUM<=1 AND VALUE="+val;
	         else
	        	 sql = "SELECT  * FROM ANSWERS WHERE QUESTION_ID="+qid[index-1]+"AND IS_CORRECT='N' AND ROWNUM<=3 AND VALUE="+val;
	        ResultSet rs1= stmt1.executeQuery(sql);
	         //Display values
	   ...
	   //-     	 System.out.println("QID: "+ assesment[i][0] );
	     ...
	     //-    System.out.println(asses);
	       ...
	       while(i<asses){
	         ...
	         String sql3 = "SELECT * FROM ANSWERS WHERE QUESTION_ID='"+assesQ[i][0]+ "' AND IS_CORRECT='Y' AND ROWNUM<=1 AND VALUE="+assesQ[i][7];
	        	 ...
	        	 while(j<8){
	        		/* 
	        		 if(j==7){
	        			 ...
	        			 assSt=Integer.toString(qlevel[i][1]);
	...
	static void  func1(String exerID1, String userID1, String couID1){
	//	 String exerID="HW1";
//		  String userID="jmick";
	//	  String couID="CSC540";
		  String exerID=exerID1;
		...
		Connection conn = null;
		   ...
		   try{
		      ...
		      String sql;
		         ...
		         String sql6="SELECT * FROM ATTEMPT WHERE USERID='"+userID+"'"+"AND COURSE_ID='"+couID+"' ORDER BY EXERCISE_ID, ATTEMPT_NO";
	  ...
	  static void func2(String exerID1, String userID1, String couID1){
		//  String exerID="HW1";
		//  String userID="jmick";
		//  String couID="CSC540";
		  String exerID=exerID1;
		        		 ...
		        		 System.out.print("Question "+(i+1)+":");
		        			...
		        			// System.out.println(rs.getString("TEXT"));
		        		        if(Integer.parseInt(part[7])!=0)
		        		          {
		        		        	  String sval;
		        		        	  sql="SELECT * FROM QUESTIONS_PARAM WHERE QUESTION_ID="+part[j];
		        		        	  ResultSet rs1= stmt1.executeQuery(sql);
		        		        	...
		        		        	//	  qlevel[index-1][1]=2;
		        		        	  ...
		        		        	  i=0;
		        				         ...
		        				         while(  i < par.length){  
		        				        	 if(i==0)
		        				        	 paramq=rs.getString("TEXT").replaceFirst("\\<[^>]*\\>", par[i]);
		        				        	 else
		        				        	 paramq=paramq.replaceFirst("\\<[^>]*\\>", par[i]); 
		        		        	  // question[index-1] = rs.getString("TEXT");
		        		       // 	System.out.println( question[index-1].replaceFirst("\\<[^>]*\\>", par[i]));
	   ...
	   public static void main(String[] args) throws Exception {
		   ...
		   switch(option) {
		   case 1:
			   func("HW1","jmick","CSC540");
	           break;
		   case 2:
			   func1("HW1","jmick","CSC540");
	           break;
		   case 3:
			   func2("HW1","jmick","CSC540");
	           break;
	        default:
	        System.out.println("Goodbye!");	
		    System.exit(0);
